...
program
  .command('start')
	.description('serve a module template powered by smt cli')

program
  .command('build')
	.description('build one or more modules in production mode to the target serve')
